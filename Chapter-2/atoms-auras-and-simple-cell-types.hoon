...
:: Atoms, Auras, and Simple Cell Types
    ...
    :: Simple Cell Types
        ...
        :: For now we'll limit ourselves to simple cell types made up of various atom types.
        ...
        :: Generic Cells
            ...
            :: The downside of using ^ for casts is that Hoon will infer only that the product of the expression is a cell; it won't be known what kind of cell is produced.
            ...
            :: When we use the ? operator to see the type inferred by Hoon for the expression, in all three of the above cases the same thing is returned: {* *}. 
            
            :: The * symbol indicates the type for any noun, and the curly braces { } indicate a cell. Every cell in Hoon is a cell of nouns; remember that cells are defined as pairs of nouns.
        ...
        :: Getting More Specific
            ...
            :: What if you want to cast for a particular kind of cell? You can use square brackets when casting for a specific cell type. 
            ...
            :: The [@ @] cast accepts any expression that evaluates to a cell with exactly two atoms, and crashes with a nest-fail for any expression that evaluates to something different. 
            
            :: The expression 12 doesn't evaluate to a cell; and while the expression [[12 13] 14] does evaluate to a cell, the left-hand side isn't an atom, but is instead another cell.
        ...
        :: You can also be highly specific with certain parts of the type structure, leaving other parts more general. 
        
        :: Keep in mind that when you do this, Hoon's type system will infer a general type from the general part of the cast. Type information may be thrown away:
        ...
        :: When you cast to * you can see the raw noun with cells as brackets and atoms as unsigned integers.
